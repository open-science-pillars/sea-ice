...
A domain capability: discipline Sea Ice inside the Cryosphere sphere. Pillar means sphere: one of the five Earth science spheres; a capability is skills, knowledge signed by its stewards and deterministic checks, delivered as one plugin.
...
Sea ice extent, concentration, thickness and motion in both hemispheres,
and the records that make a trend claim defensible.

## Ownership

Owned by @open-science-pillars/cryosphere-maintainers (`CODEOWNERS`); one person
...
here relies on: NSIDC DAAC (passive microwave concentration, ICESat-2 freeboard). None engaged yet.
